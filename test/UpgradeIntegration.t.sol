...
contract UpgradeIntegrationTest is Test {
    ...
    function testMultipleContractUpgrades() public {
        ...
        bytes memory govInitData = abi.encodeWithSignature(
            "initialize(address,address,address,address)", address(token), membershipNFT, investorNFT, owner
        );
        migrationProxy.deployProxy(address(governanceImplementation), govInitData, "Governance");
